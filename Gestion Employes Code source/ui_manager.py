...
def main():
    ...
    def sort_listbox():
        """
        Trie les éléments de la liste des employés dans le Listbox.
        """
    ...
    def on_select(event):
        """
        Gère l'événement de sélection d'un employé dans la liste des employés.
        """
    ...
    def configure_entry(entry):
        """
        Configure le style des champs de saisie.
        """
